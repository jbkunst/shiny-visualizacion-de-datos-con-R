...
- https://www.colorhexa.com/202A44


---

# Incorporando propios estilos + {thematic} + {showtext}

Adicionalmene:

- Con {thematic} los gráficos incorporarán las mismas reglas de estilo -colores- que la aplicación.
- Con {showtext}, los gráficos incorporarán las fuentes utilizadas.
...
- Aplicar un tema utilizando `bs_theme`.
