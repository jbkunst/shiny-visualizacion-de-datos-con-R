...
<!-- `flipbookr::chunk_reveal("highcharter", title = "# {highcharter}")` -->
...
<!-- `flipbookr::chunk_reveal("sismos", title = "# Antes, unos datos", widths = c(1, 2))`   -->
...
<!-- `flipbookr::chunk_reveal("dt", title = "# {DT}", widths = c(1, 4))` -->
...
<!-- `flipbookr::chunk_reveal("leaflet", title = "# {leaflet}")` -->
